...
import evaluation.rotate_icdar13.rrc_evaluation_funcs as rrc_evaluation_funcs
# import rrc_evaluation_funcs as rrc_evaluation_funcs
import importlib
...
def text_eval_main(det_file, gt_file, is_word_spotting):
    ...
    return rrc_evaluation_funcs.main_evaluation(p, default_evaluation_params,validate_data,evaluate_method,show_result=True)
...
if __name__=='__main__':
    ...
    # result_path = "/data4/gyh/codes/detectron2/ic13_video_test83_det.zip"
    
    result_path = "/data/gyh/codes/mmtracking/pkl_results/selsa_faster_rcnn_r50_fpn_21_epoch_bilateral_uniform_10_refs/selsa.zip"
    gt_path = "/data1/gyh/data/ICDAR2013_Video/ic13_video_test.zip"
    text_eval_main(det_file=result_path, gt_file=gt_path, is_word_spotting=False)