...
class TextEvaluator13(DatasetEvaluator):
    """
    ...
    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        ...
        if "totaltext" in dataset_name:
            ...
            self._text_eval_gt_path = "/data4/gyh/data/ICDAR2013_Video/ic13_video_test.zip"
            print(self._text_eval_gt_path)
            self._word_spotting = False
    ...
    def evaluate(self):
        ...
        self.to_eval_format(file_path, temp_dir, 0.5)
...
def instances_to_coco_json_without_recs(instances, img_id):
    ...
    # points =  instances.points.numpy() if instances.has("points") else None
    ...
    #     for point, score, box in zip(points, scores, boxes):
    #         result = {
    #             "image_id": img_id,
    #             "category_id": 1,
    #             "polys": point.reshape(-1,2).tolist(),
    #             "score": score,
    #         }
    #         results.append(result)
    # else:
